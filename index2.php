                        ...
                        <ul class="nav navbar-nav">
                            ...
                            <li class="dropdown">
                                ...
                                <ul class="dropdown-menu">
                                    <li><a href="compra.php">Primera Carta </a></li>
                                    <li><a href="compro.php">Segunda Carta </a></li>  
                                    <li><a href="compra.php">Tercera Carta</a></li>
                                    <li><a href="compro.php">Cuartaq Carta </a></li>  
                                    <li><a href="compra.php">Quinta Carta </a></li>
                                    <li><a href="compro.php">Sexta Carta</a></li>                              
                                </ul>
                            </li>
...
<div class="actions" align="center">
        ...
        <h3>Rellene el campos segun requiera el llenado</h3>
        <form class="form-horizontal" method="post" action="alta.php" onsubmit="javascript:return Validar(this);" >
