<?php
	...
	//Verificacion de registros o nulacion de dicha operacion
		if($registro){
	echo"<script type=\"text/javascript\">alert('USUARIO ".$nombre." AGREGADO'); window.location='index2.php';</script>"; 
		}else{
	echo"<script type=\"text/javascript\">alert('usuario NO AGREGADO'); window.location='index2.php';</script>";
		}
?> 